					    ...
					    <div class='control-group'>
					    	...
					    	<div class='controls loan'>
					    		<div class='box'>
					    			...
					    			<?php echo form_dropdown("member[]",$members,"","class='required member'");?>&nbsp;<a href='javascript:void(0);' class='del' onclick='del(this)'>x</a>
					    			</div>
					    		</div>
					    		<?php
					    		if(count($f2)>0){
						    		foreach($f2 as $ff){
							    		?>
							    		<div class='box2'>
							    			<?php echo form_dropdown("member[]",$members,$ff->register_no,"class='required member'");?>&nbsp;<a href='javascript:void(0);' class='del' onclick='del(this)'>x</a>
							    		</div>
							    		<?php
						    		}
					    		}

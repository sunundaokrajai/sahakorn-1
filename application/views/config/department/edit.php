		...
		<div class="span12">
		    ...
		    <div class="widget">
			    <div class="widget-header">
			    	<span class="title">แก้ไขข้อมูลหน่วยงาน</span>
			    </div>
			    ...
			    <div class="widget-content form-container">
				    <?php echo form_open("",array("class"=>"form-horizontal"));?>
					    <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" name="departments_name" value="<?php echo $r->departments_name;?>" class="span6 required">
						    </div>
					    </div>

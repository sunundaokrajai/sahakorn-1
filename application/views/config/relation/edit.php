...
<div id="main-header" class="page-header">
	<ul class="breadcrumb">
	    ...
	    <li>
	    	<a href="#">แก้ไขข้อมูลความสัมพันธ์</a>
	    </li>
	</ul>
		...
		<div class="span12">
		    ...
		    <div class="widget">
			    <div class="widget-header">
			    	<span class="title">แก้ไขข้อมูลความสัมพันธ์</span>
			    </div>
			    ...
			    <div class="widget-content form-container">
				    <?php echo form_open("",array("class"=>"form-horizontal"));?>
					    <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" name="relationship_name" value="<?php echo $r->relationship_name;?>" class="span6 required">
						    </div>
					    </div>

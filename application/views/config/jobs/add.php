...
<div id="main-header" class="page-header">
	<ul class="breadcrumb">
	    ...
	    <li>
	    	<a href="<?php echo site_url("config/่jobs");?>">จัดการตำแหน่งงาน</a><span class="divider">&raquo;</span>

	    </li>
	    <li>
	    	<a href="#">เพิ่มข้อมูลตำแหน่งงาน </a>
	    </li>
	</ul>
		...
		<div class="span12">
		    ...
		    <div class="widget">
			    <div class="widget-header">
			    	<span class="title">เพิ่มข้อมูลตำแหน่งงาน</span>
			    </div>
			    ...
			    <div class="widget-content form-container">
				    <?php echo form_open("",array("class"=>"form-horizontal"));?>
					    <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" name="jobs_name" value="" class="span6 required">
						    </div>
					    </div>
